  ...
  return (
    <div className="shadow-md shadow-black/20 border dark:border-white flex items-center justify-center rounded-lg md:justify-start px-1 sm:px-2 py-2 lg:py-4 lg:px-4 mb-4">
      <div className="flex items-center text-neutral-900 dark:text-neutral-300">
        ...
        <span className="mx-1 sm:mx-2 font-semibold text-sm sm:text-lg lg:text-xl text-neutral-700 dark:text-neutral-100">
          Categories
        </span>
      </div>
      ...
      {showContactInfo && (
        <>
          ...
          <div className="flex items-center text-neutral-900 dark:text-neutral-300">
            ...
            <span className="mx-1 lg:mx-2 font-semibold  text-sm sm:text-lg lg:text-xl text-neutral-700 dark:text-neutral-100">
              Book
            </span>
          </div>
        </>
