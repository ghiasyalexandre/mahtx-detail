    ...
    <>
      <div className="dark:bg-gradient-to-tr bg-white dark:bg-transparent dark:from-white/20 dark:via-transparent flex flex-col justify-center transition-colors duration-500 ease-in-out">
        <div className="mx-auto max-w-7xl pb-16 pt-12 sm:pt-16 lg:pb-32">
          ...
          >
            <h1 className="text-4xl sm:text-6xl font-bold uppercase text-black dark:text-white mb-4">
            ...
            <p className="text-lg mx-8 text-gray-600 dark:text-gray-400">
              Premium detailing services to keep your car or plane looking brand
              new, inside and out.
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 px-4 mx-4">
            {[
              {
              ...
              >
                ...
                >
                  <div>
                    <h2 className="text-xl font-semibold mb-2 text-white dark:text-neutral-800">
                      {service.title}
                    </h2>
        ...
        <div className="container max-w-7xl px-8 py-8  mx-auto xl:shadow-neonDark xl:dark:shadow-neonLight rounded-xl">
          <div className=" flex justify-center text-center">
            <div className="col-span-1">
              ...
              <h1 className="mt-2 text-3xl font-semibold text-black md:text-4xl dark:text-white">
                Contact Us{" "}
              </h1>
          ...
          <div className="grid grid-cols-1 gap-4 gap-y-10 mt-10 lg:grid-cols-3">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-1">
              <div>
                ...
                <h2 className="mt-4 text-base lg:text-lg font-medium text-gray-800 dark:text-white">
                  Email
                </h2>
